...
- `Assets/Atlas.Client.Unity/*.cs` — `rmtree` + `copytree` mirror of
...
`Assets/Atlas.Client.Unity/` will be **silently overwritten** by the
next setup run — always edit the `src/csharp/...` source.
