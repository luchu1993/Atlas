...
| Script 3 | Atlas 引擎 C# 绑定 | 进行中 | [script_phase3](../scripting/script_phase3_engine_bindings.md) |
| Script 4 | 共享程序集 + Source Generator | 待开始 | [script_phase4](../scripting/script_phase4_shared_generators.md) |
...
| 7 | DBApp + 数据库层 | IDatabase 接口、XML/MySQL 后端、异步持久化 | [phase07_dbapp.md](phase07_dbapp.md) |
