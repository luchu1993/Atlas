...
> 状态: 参考资料。本文聚焦 BigWorld 原始机制；Atlas 当前 RPC wire
> contract 见 [Atlas RPC wire contract](../rpc/RPC_AUDIT_REMEDIATION.md)。
>
...
> Atlas 侧当前 RPC ID 与 wire 字段速查见
> [Atlas RPC wire contract](../rpc/RPC_AUDIT_REMEDIATION.md)。
