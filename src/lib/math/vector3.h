#ifndef ATLAS_LIB_MATH_VECTOR3_H_
#define ATLAS_LIB_MATH_VECTOR3_H_
...
struct Vector3 {
  ...
  [[nodiscard]] constexpr auto LengthSquared() const -> float { return x * x + y * y + z * z; }
  ...
  [[nodiscard]] constexpr auto DistanceSquared(const Vector3& v) const -> float {
  ...
  static constexpr auto UnitX() -> Vector3 { return {1, 0, 0}; }
  static constexpr auto UnitY() -> Vector3 { return {0, 1, 0}; }
  static constexpr auto UnitZ() -> Vector3 { return {0, 0, 1}; }
};
...
#endif  // ATLAS_LIB_MATH_VECTOR3_H_
