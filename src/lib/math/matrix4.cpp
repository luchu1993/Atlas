...
auto Matrix4::rotation_x(float radians) -> Matrix4
{
...
auto Matrix4::rotation_y(float radians) -> Matrix4
{
    Matrix4 result = identity();
    float c = std::cos(radians);
    float s = std::sin(radians);
...
auto Matrix4::rotation_z(float radians) -> Matrix4
{
    Matrix4 result = identity();
    float c = std::cos(radians);
    float s = std::sin(radians);
...
auto Matrix4::look_at(const Vector3& eye, const Vector3& target, const Vector3& up) -> Matrix4
{
...
auto Matrix4::transform_point(const Vector3& p) const -> Vector3
{
...
auto Matrix4::transform_vector(const Vector3& v) const -> Vector3
{
