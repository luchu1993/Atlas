#ifndef ATLAS_LIB_FOUNDATION_CONTAINERS_OBJECT_POOL_H_
#define ATLAS_LIB_FOUNDATION_CONTAINERS_OBJECT_POOL_H_
...
#endif  // ATLAS_LIB_FOUNDATION_CONTAINERS_OBJECT_POOL_H_
